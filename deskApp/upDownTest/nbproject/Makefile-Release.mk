...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/updowntest

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/updowntest: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/updowntest ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/_ext/b5cf6509/UpDownTest.o: /home/thanh/aos/system/SMART_DESK/deskApp/upDownTest/UpDownTest.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b5cf6509/UpDownTest.o /home/thanh/aos/system/SMART_DESK/deskApp/upDownTest/UpDownTest.cpp
